...
def cli(profile):
    ...
    bucket_manager = bucket.BucketManager(session)
    domain_manager = domain.DomainManager(session)
    cert_manager = certificate.CertificateManager(session)
    dist_manager = cdn.DistributionManager(session)
